...
export const mockShouldShowWatermarkForRender = vi.fn().mockReturnValue(false);
...
export function databaseMockFactory() {
  return {
    ...
    shouldShowWatermarkForRender: (...args: unknown[]) => mockShouldShowWatermarkForRender(...args),
